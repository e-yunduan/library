...
//        '嗯' => 'ng',
    ...
    {
//        return count(static::$dic);
        $a = mt_rand(0, 6932);
        $b = mt_rand(0, 6932);
        $value = array_keys(static::$dic)[$a] . array_keys(static::$dic)[$b];
        $key = array_values(static::$dic)[$a] . array_values(static::$dic)[$b];
        return [$key => $value];
    }

    public static function traverse($i, $j)
    {
        $value = array_keys(static::$dic)[$i] . array_keys(static::$dic)[$j];
        $key = array_values(static::$dic)[$i] . array_values(static::$dic)[$j];
        return [$key => $value];
    }
